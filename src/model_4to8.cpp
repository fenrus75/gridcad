...
void model_4to8::drawAt(class basecanvas *canvas, float X, float Y, int type)
{
...
std::string model_4to8::get_verilog_main(void)
{
    ...
    s = s + "assign " + ports[2]->get_net_verilog_name()+ " = {" + ports[0]->get_net_verilog_name("4'b0") + ", " +ports[1]->get_net_verilog_name("4'b0") + "};\n";
