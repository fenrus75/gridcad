...
IMGUI := imgui/imgui.o  imgui/imgui_demo.o  imgui/imgui_draw.o  imgui/imgui_tables.o  imgui/imgui_widgets.o imgui/backends/imgui_impl_sdl2.o imgui/backends/imgui_impl_sdlrenderer2.o imgui_hex_editor/imgui_hex.o
SEQUENCER := src/sequencer/model_sequencer.o src/sequencer/seqcanvas.o
...
MODELS :=  $(SEQUENCER) src/model_buffer.o src/model_logic2.o src/model_nand.o src/model_and.o src/model_not.o src/model_toggle.o src/model_nor.o src/model_or.o src/model_output.o src/model_xor.o  $(TRUTH) $(NEST) src/model_4to1.o src/model_1to4.o src/model_8to4.o src/model_4to8.o src/model_datascope.o src/model_dflipflop.o src/model_delayline.o src/model_8to16.o src/model_16to8.o src/model_memory.o src/model_label.o src/model_1to8.o src/model_8to1.o src/model_deflipflop.o
OBJS := $(PROJECT) src/hexcanvas.o src/net.o src/synth.o src/dialog.o src/buttonbar.o src/main.o src/document.o src/canvas.o src/scene.o src/color.o src/element.o src/wire.o src/connector.o src/port.o src/model_zero.o src/model_one.o src/iconbar.o lib/wirepath.o src/factory.o src/basecanvas.o $(MODELS) src/event.o src/uuid.o src/library.o src/queued.o src/contextmenu.o src/name.o  $(IMGUI)
PNG := pngs.o
...
.cpp.o:
	g++ $(CXXFLAGS) -fvisibility=hidden -Iinclude/ -Iimgui/ -Iimgui_hex_editor/ `pkg-config --cflags sdl2` -O2 -Wall -march=native -flto -g $(SAN) -std=c++20  -c $< -o $@
...
devdeps:
	sudo apt install libsdl2-dev libsdl2-image-dev libsdl2-gfx-dev nlohmann-json3-dev xutils-dev libsdl2-ttf-dev curl g++ xutils-dev
...
depend:
	...
	makedepend -f Makefile.deps -- $(CFLAGS) -Iinclude/ -- src/*cpp src/*/*cpp test/*cpp include/*.h lib/*cpp
