...
MODELS :=  src/model_logic2.o src/model_nand.o src/model_and.o src/model_not.o src/model_toggle.o src/model_nor.o src/model_or.o src/model_output.o src/model_xor.o  $(TRUTH) $(NEST) src/model_4to1.o src/model_1to4.o src/model_8to4.o src/model_4to8.o src/model_datascope.o src/model_dflipflop.o src/model_delayline.o src/model_8to16.o src/model_16to8.o src/model_memory.o src/model_label.o src/model_1to8.o src/model_8to1.o
OBJS := $(PROJECT) src/buttonbar.o src/main.o src/document.o src/canvas.o src/scene.o src/color.o src/element.o src/wire.o src/connector.o src/port.o src/model_zero.o src/model_one.o src/iconbar.o lib/wirepath.o src/factory.o src/basecanvas.o $(MODELS) src/event.o src/uuid.o src/library.o src/queued.o src/contextmenu.o src/name.o 
PNG := pngs.o

gridcad: $(OBJS) $(PNG) include/gridcad.h Makefile Makefile.deps
	g++ $(CFLAGS) -O3 -Wall -march=native $(OBJS) $(PNG) $(LTO) $(SAN) -o gridcad -lSDL2_image -lSDL2_gfx -lSDL2_ttf -lSDL2
