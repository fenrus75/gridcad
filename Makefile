...
gridcad: $(OBJS) include/gridcad.h Makefile Makefile.deps
	g++ $(CFLAGS) -O3 -Wall -march=native $(OBJS) $(LTO) -fsanitize=address -o gridcad -lSDL2_image -lSDL2_gfx -lSDL2_ttf -lSDL2 
...
.cpp.o:
	g++ $(CXXFLAGS) -fvisibility=hidden -Iinclude/ -O3 -Wall -march=native -flto -g -fsanitize=address -c $< -o $@
