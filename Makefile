...
OBJS := src/main.o src/scene.o src/color.o src/element.o src/wire.o src/connector.o src/port.o src/twogate.o src/model_zero.o src/model_one.o src/iconbar.o src/model_logic2.o src/model_nand.o lib/wirepath.o 
