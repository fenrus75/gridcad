...
MODELS :=  src/model_logic2.o src/model_nand.o src/model_and.o src/model_not.o src/model_toggle.o src/model_nor.o src/model_or.o src/model_output.o src/model_xor.o  $(TRUTH) $(NEST) src/model_4to1.o src/model_1to4.o src/model_8to4.o
