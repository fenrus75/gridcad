...
OBJS := src/main.o src/scene.o src/color.o src/element.o src/wire.o src/connector.o src/port.o src/twogate.o src/model_zero.o src/model_one.o lib/wirepath.o 
